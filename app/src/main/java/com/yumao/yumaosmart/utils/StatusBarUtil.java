...
public class StatusBarUtil {
    ...
    public static int obtainHeight(Context context) {
        ...
        LogUtils.d("status bar height: " + result + " px");
        height = result;
        return result;
    }
    ...
    private static int obtainDimenResId(Context ctx) throws ClassNotFoundException,
        ...
        LogUtils.d("will obtain status bar height from dimen resources");
        int resourceId = ctx.getResources().getIdentifier("status_bar_height", "dimen", "android");
        if (resourceId > 0) {
            return resourceId;
        }
        LogUtils.d("will obtain status bar height from R$dimen class");
