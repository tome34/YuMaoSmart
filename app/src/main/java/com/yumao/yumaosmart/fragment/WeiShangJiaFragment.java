...
import com.yumao.yumaosmart.adapter.WeiShangjiaAdapter;
 ...
 */
public class WeiShangJiaFragment extends Fragment {

    @BindView(R.id.lv_fragment_weishangjia)
    ListView mLvFragmentWeishangjia;
    private View mFragmentView;
    private Activity mActivity;
    private List<GoodsUploadBean> mList;
    private GoodsUploadBean mGoodsUploadBean;
    private WeiShangjiaAdapter mWeiShangjiaAdapter;


    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        mFragmentView = View.inflate(UiUtilities.getContex(), R.layout.layout_fragment_weishangjia, null);
    ...
    private void initView() {
        mWeiShangjiaAdapter = new WeiShangjiaAdapter(getActivity(), R.layout.item_fragment_weishangjia, mList);
        mLvFragmentWeishangjia.setAdapter(mWeiShangjiaAdapter);
    }
