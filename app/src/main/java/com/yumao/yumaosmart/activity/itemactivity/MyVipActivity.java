...
public class MyVipActivity extends BaseItemActivity {



    @BindView(R.id.search_my_vip)
    SearchView mSearchMyVip;
    @BindView(R.id.rv_activity_my_vip)
    RecyclerView mRvActivityMyVip;
    @BindView(R.id.activity_my_vip)
    LinearLayout mActivityMyVip;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initToobar(getString(R.string.title_my_vip));
        init();
        initData();
    ...
    private void initView() {
        ...
        mRvActivityMyVip.setLayoutManager(linearLayoutManager);
     ...
     HeaderAndFooterWrapper   mHeaderAndFooterWrapper = new HeaderAndFooterWrapper(mMyVipAdapter);
      LayoutInflater  mInflater = LayoutInflater.from(this);
        ...
        mRvActivityMyVip.setAdapter(mHeaderAndFooterWrapper);
