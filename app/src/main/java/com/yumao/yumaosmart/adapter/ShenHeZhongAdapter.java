...
public class ShenHeZhongAdapter extends CommonAdapter<GoodsUploadBean> {
    public ShenHeZhongAdapter(Context context, int layoutId, List<GoodsUploadBean> datas) {
