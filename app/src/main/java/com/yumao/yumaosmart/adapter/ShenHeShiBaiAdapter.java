...
public class ShenHeShiBaiAdapter extends CommonAdapter<GoodsUploadBean> {

    public ShenHeShiBaiAdapter(Context context, int layoutId, List<GoodsUploadBean> datas) {
